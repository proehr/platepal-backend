package com.pli.codes.platepal.service;

import com.pli.codes.platepal.model.entity.Account;
import com.pli.codes.platepal.model.mapping.PlatePalUserDetailsMapper;
import com.pli.codes.platepal.model.repository.AccountRepository;
...
public class AccountService implements UserDetailsManager {
    ...
    public void createUser(UserDetails user) {
        createUser(Mappers
                .getMapper(PlatePalUserDetailsMapper.class)
                .userDetailsToAccount((PlatePalUserDetails) user)
        );
    }
