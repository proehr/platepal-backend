package com.pli.codes.platepal.accounts.controller;

import com.pli.codes.platepal.accounts.model.entity.Account;
import com.pli.codes.platepal.accounts.payload.request.LoginRequest;
import com.pli.codes.platepal.accounts.payload.response.JwtResponse;
import com.pli.codes.platepal.accounts.security.jwt.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<JwtResponse> registerUser(@RequestBody LoginRequest registerRequest) {
        ...
        Account account = new Account(registerRequest.getEmailAddress(), encoder.encode(registerRequest.getPassword()));
